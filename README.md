# 💼 Portfólio Profissional - Lucas Martins Hilario
...
Portfólio pessoal desenvolvido com design **Synthwave/Cyberpunk** profissional, construído com HTML, CSS e JavaScript puro. O projeto apresenta uma interface moderna e responsiva, com animações suaves e efeitos visuais impactantes.
...
- ✅ Menu de navegação responsivo com hamburguer menu
- ✅ Animações ao rolar a página (scroll reveal)
- ✅ Contadores animados de estatísticas
- ✅ Cards de tecnologias com barras de progresso
- ✅ Seção de projetos (preparada para expansão)
...
- [ ] Adicionar mais projetos na seção de trabalhos
...
**Desenvolvido com 💜 por Lucas Martins Hilario**
